...
module phase_field
 integer :: phi_flag,phicor_flag,in_cond_phi,b_type,phiflux_flag,body_flag,rep_flag
 double precision :: rhor,visr,We,Ch,Pe,Fr,grav(3),s_coeff,lamphi,body_c,body_d(3),rep_c
