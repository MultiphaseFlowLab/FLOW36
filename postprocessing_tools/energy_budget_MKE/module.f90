module commondata
 ...
 integer :: phi_flag,psi_flag,b_type
 ...
 double precision :: re,ch,we,betas,visr,rhor,dt,gradpx,gradpy,co,Fr
...
module fields
 double precision, dimension(:,:,:), allocatable :: u,v,w,phi,psi,press
 double precision, dimension(:,:,:,:), allocatable :: uc,vc,wc,phic,psic
 double precision, dimension(:), allocatable :: pm,prms
end module fields
...
module fftw3
 ...
 type(c_ptr) :: plan_z_fwd_1D,plan_z_bwd_2D
end module fftw3
