...
real(c_double), allocatable :: b_in(:,:,:)
real(c_double) :: tin(expz*(nz-1)+1),tout(expz*(nz-1)+1)
complex(c_double_complex), allocatable :: b_out(:,:,:), b_t(:,:,:)
...
integer(c_int) :: dims(1)
integer(c_int) :: inembed(2),onembed(2),istride,ostride,idist,odist
...
#if flag_fftw == 0
plan_x_fwd_2D=fftw_plan_many_dft_r2c(1,dims,ny,b_in,inembed,istride,idist,&
 &    b_t,onembed,ostride,odist,FFTW_ESTIMATE)
#elif flag_fftw == 1
plan_x_fwd_2D=fftw_plan_many_dft_r2c(1,dims,ny,b_in,inembed,istride,idist,&
 &    b_t,onembed,ostride,odist,FFTW_PATIENT)
...
! -1=FFT_FORWARD
#if flag_fftw == 0
plan_y_fwd_2D=fftw_plan_many_dft(1,dims,nsx,b_t,inembed,istride,idist, &
 &    b_out,onembed,ostride,odist,-1,FFTW_ESTIMATE)
#elif flag_fftw == 1
plan_y_fwd_2D=fftw_plan_many_dft(1,dims,nsx,b_t,inembed,istride,idist, &
 &    b_out,onembed,ostride,odist,-1,FFTW_PATIENT)
