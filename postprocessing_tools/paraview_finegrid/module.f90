module commondata
 ...
 double precision, allocatable, dimension(:,:,:) :: u,v,w,phi,psi,theta, u_fg,v_fg,w_fg,phi_fg,psi_fg,theta_fg
 double precision, allocatable,dimension(:) :: x,y,z, x_fg,y_fg,z_fg
